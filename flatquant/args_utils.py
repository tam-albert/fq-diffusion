...
def parser_gen():
    ...
    parser.add_argument(
        "--act_order", action="store_true", default=False, help="Use act-order in GPTQ."
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Warm up the learning rate during training.",
    )
    parser.add_argument(
        "--deactive_amp",
        default=False,
    ...
    args.exp_dir = os.path.join(
        args.output_dir, args.model_name, f"w{args.w_bits}a{args.a_bits}", args.exp_name
    )
